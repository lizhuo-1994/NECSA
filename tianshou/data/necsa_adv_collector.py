...
from .abstracter_adv import Abstracter, ScoreInspector

class NECSA_Adv_Collector(object):
    ...
    def collect(
        ...
        while True:
            ...
            self.state_list.append(list(observation))
            self.action_list.append(list(action))
            self.reward_list.append(reward)
        

            if done:
                self.reward_list = self.abstracter.reward_shaping(np.array(self.state_list), np.array(self.action_list), np.array(self.reward_list))
